...
| **Check mode** | the **Notes** / **Check** button beside Mic. In Check, play along with the song: each note of the selected layer is judged once the playhead has passed it - outlined **green** when you played it in tune, **blue** when nearly (out of tune by more than 25 cents, a semitone off, in another octave, or for less than half of it), **red** when you did not play it. Chords are checked note by note. When playback stops, the status line counts them up. The outlines stay until Play or Reset |
